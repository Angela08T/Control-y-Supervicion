# Sistema de Control y Supervisión - Centinela
...
- **Gestión de Incidencias**: Registro de faltas disciplinarias, abandonos de servicio e inasistencias
- **Geolocalización**: Selección de ubicación mediante mapas interactivos con Leaflet
- **Generación de Reportes PDF**: Creación automática de informes con jsPDF
- **Sistema de Bodycams**: Vinculación de evidencia con dispositivos bodycam
- **Control de Turnos**: Gestión por turnos (Mañana, Tarde, Noche)
- **Multi-rol**: Soporte para Admin, Supervisor, Centinela y Validador
- **Historial de Ausencias**: Seguimiento de inasistencias por DNI
